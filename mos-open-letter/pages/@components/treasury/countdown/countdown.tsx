...
import { proposal } from '../../../../lib/auctionDate'
...
const Countdown: FunctionComponent = () => {
  ...
  const useCountdown = () => {
    const countDownDate = new Date(proposal).getTime()
  ...
  return (
    <div className={`${styles.content} max-w-7xl mx-auto`}>
      <div className={styles.countdownSection}>
        ...
        <p className={styles.countdownSection__subtitle}>
          {' '}
          Proposals Open In...
        </p>
        ...
        <p className={styles.countdownSection__text}>
          {isSent ? (
            <>
              ...
              reminders so you can keep up to date with proposal submission and
              voting details.
            </>
          ) : (
            'Drop your email below to be notified when proposal submissions/voting opens. '
          )}
        </p>
